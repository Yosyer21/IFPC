...
export function CreateEvaluationForm({ playerId }: { playerId: string }) {
  ...
  return (
    <form action={formAction} className="flex max-w-xl flex-col gap-4">
      ...
      <Select name="category" label="Categoría" options={CATEGORY_OPTIONS} defaultValue="technical" />
      <Input name="score" type="number" label="Puntuación (1-10)" min={1} max={10} required />
      <div className="flex flex-col gap-1.5">
        ...
        <textarea
          ...
          name="notes"
          rows={3}
          placeholder="Fortalezas, áreas de mejora, comentarios…"
