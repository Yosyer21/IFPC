...
const PLANS: {
...
}[] = [
  {
    ...
    label: 'Gratis',
    price: '0 €',
    features: ['Basic profile', 'Contenido de entrenamiento', 'Aplicar a oportunidades'],
  },
  {
    tier: 'PREMIUM',
    label: 'Premium',
    price: '€99/year',
    features: ['Profile destacado', 'Unlimited videos', 'Development statistics', 'Insignia verificada'],
  },
  {
    tier: 'SCOUT',
    label: 'Scout',
    price: '€199/year',
    features: ['Acceso a informes de scouting', 'Advanced player search', 'Guardar jugadores'],
  },
  {
    tier: 'CLUB',
    label: 'Club',
